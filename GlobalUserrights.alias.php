...
$specialPageAliases['ar'] = [
	'GlobalUserrights' => [ 'صلاحيات_المستخدم_العالمية', 'عضوية_المجموعة_العالمية' ],
];
...
$specialPageAliases['bs'] = [
	'GlobalUserrights' => [ 'PravaGlobalnihKorisnika', 'ClanstvoGlobalnihGrupa' ],
];
...
$specialPageAliases['es'] = [
	'GlobalUserrights' => [ 'Permisos_de_usuarios_globales', 'Permisos_usuarios_globales', 'Derechos_usuarios_globales' ],
];
...
$specialPageAliases['fr'] = [
	'GlobalUserrights' => [ 'Droits_des_utilisateurs_globaux', 'DroitsDesUtilisateursGlobaux' ],
];

/** Franco-Provençal (arpetan) */
$specialPageAliases['frp'] = [
	'GlobalUserrights' => [ 'Drêts_ux_usanciérs_globâls', 'DrêtsUxUsanciérsGlobâls' ],
];
...
$specialPageAliases['id'] = [
	'GlobalUserrights' => [ 'Keanggotaan_grup_global', 'KeanggotaanGrupGlobal' ],
];
...
$specialPageAliases['ksh'] = [
	'GlobalUserrights' => [ 'Jemeinsam_Metmaacher_Rääschte', 'Jemeinsam_Medmaacher_Rääschte', 'JemeinsamMetmaacherRääschte', 'JemeinsamMedmaacherRääschte' ],
];
...
$specialPageAliases['oc'] = [
	'GlobalUserrights' => [ 'Dreches_dels_utilizaires_globals', 'DrechesDelsUtilizairesGlobals' ],
];
